...
//        search(queryAnalyzer, directory, "\"季德胜蛇药片\"");
        search(queryAnalyzer, directory, "心中心");
...
//        DirectoryReader directoryReader = IndexReader.open(directory);
        ...
        Term termInstance = new Term("text", queryStr);
      ...
      /*
        ...
        QueryParser tq = new QueryParser(Version.LUCENE_47, "text", queryAnalyzer);
